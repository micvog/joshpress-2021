...
This post is about setup for PHP 8 web development for Windows. I have a [similar post](https://joshpress.net/blog/wsl-ubuntu-php7) about setting up the PHP 7 linux. In this post I will show what I do __after__ setting up WSL2 for PHP and JavaScript development.
